...
/*Saya Atta Arrezie Kurnia (2006836) mengerjakan Latihan 2 
  ...
  2. Python/php -> hanya berupa hardcode yang menampilkan 8 data mahasiswa yaitu nama, nim, nik, kelamin, email univ, asal univ, prodi, dan fakultas yang dipilih (file php ada di folder latihan2)
